...
import com.mycompany.board.common.ResultUtil;
...
public class BoardController {
	...
	public ResultUtil getBoardList(HttpServletRequest request, HttpServletResponse response, BoardForm boardForm)
			throws Exception {
		System.out.println("boardform:::" + boardForm.getCurrent_page_no());
	 ...
	 * @RequestMapping(value = "/getBoardList")
	 * 
	 * @ResponseBody public List<BoardDto> getBoardList(HttpServletRequest request,
	 * HttpServletResponse response, BoardForm boardForm) throws Exception {
	 * 
	 * 
	...
	public BoardDto insertBoard(HttpServletRequest request, HttpServletResponse response, BoardForm boardForm)
		...
		System.out.println("boardDTO::" + boardDto.getBoard_seq());
